...
var plugNews = function (assetKey) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, http_client_1.default.get("v1/news/" + assetKey + "?page=1&as-markdown").json()];
            case 1:
                newsArticles = (_a.sent()).data;
                onSubmit = function (_, answer) { return console.log(marked_1.default(answer)); };
                newsChoices = newsArticles.map(function (n, i) { return ({
                    title: "(" + (i + 1) + ") " + n.title,
                    description: "🚀",
                    value: n.content
                }); });
                ...
                return [4 /*yield*/, prompts_1.default(prompt_1, { onSubmit: onSubmit })];
            case 2:
                // Call prompts to view news options
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                console.error("Error: ", error_1.response.body);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
}); };
exports.default = plugNews;
